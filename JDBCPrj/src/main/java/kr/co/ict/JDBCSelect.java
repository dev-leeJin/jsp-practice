...
public class JDBCSelect {
	...
	public static void main(String[] args) {
		...
		// get자료형(인덱스번호, 1부터 시작) or get자료형(컬럼명)을 쓰면
		// 해당 컬럼의 자료를 반환합니다.
		/*rs.next(); //# 0번 으로 넘어감
		System.out.println(rs.getString(1)); //# 1번컬럼 조회 
		...
		while(rs.next()) { //boolean자료형이므로 while문 사이에 true가 들어가기 때문에 진입->4번 인덱스에서 자료가 없으므로 false->탈출
